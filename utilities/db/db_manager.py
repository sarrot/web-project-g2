...
class DBManager:
    ...
    def insert_user(self, first_name, last_name, email, password_user):
        query = "INSERT INTO users(first_name,last_name, email, password_user) VALUES ('%s','%s','%s', '%s')" % (first_name, last_name, email, password_user)
        self.commit(query)
